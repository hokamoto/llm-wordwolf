...
| `--models m1,m2,...` | openai/o4-mini | カンマ区切りの[OpenRouterモデルID](https://openrouter.ai/models?fmt=cards&input_modalities=text&output_modalities=text)。プレイヤーごとに指定するか、全プレイヤーに同一モデルを指定 |
