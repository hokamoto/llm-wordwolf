...
| `--models m1,m2,...` | openai/o4-mini | Comma-separated [OpenRouter model IDs](https://openrouter.ai/models?fmt=cards&input_modalities=text&output_modalities=text); one per player, or a single model for all players |
...
You can view a sample replay at [`examples/wordwolf_replay.html`](./examples/wordwolf_replay.html).
